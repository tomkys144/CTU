...
if exist('/etc/init.d'),
    ...
    % dbdir='../signaly/zreratdb'; 
    dbdir='/home/pollak/www/html/vyu/data/zreratdb'; 
else
    % For windows
    if exist('H:\VYUKA')
        addpath H:\VYUKA\DSP\m; 
        addpath H:\VYUKA\DSP\signaly; 
        dbdir='H:\VYUKA\ZRE\signaly\zreratdb'; 
    else
        addpath C:\usr\pollak\www\html\vyu\b2m31dsp\m
        addpath C:\usr\pollak\www\html\vyu\b2m31dsp\signaly
        dbdir='C:\usr\pollak\www\html\vyu\data\zreratdb'; 
        % dbdir='C:\usr\pollak\vyuka\speech\signaly\zreratdb'; 
    end
end
